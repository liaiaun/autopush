...
def get_weather():
    city_name = config["province"]+config["city"]
    ...
    headers = {
        ...
        'Referer':'http://www.weather.com.cn/weather1d/101320101.shtml',
...
if __name__ == "__main__":
    ...
    # 公众号推送消息
    for user in users:
        print(user,accessToken, city_name,today_date,today_weather,now,today_wind,tomorrow,tomorrow_weather,tomorrow_max,tomorrow_min,tomorrow_wind,daily_love,note_ch, note_en)
